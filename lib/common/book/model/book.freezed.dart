...
abstract class $BookModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, int wordCount});
}
...
/// @nodoc
@JsonSerializable()
class _$BookModelImpl with DiagnosticableTreeMixin implements _BookModel {
  const _$BookModelImpl(
      {required this.id, required this.name, required this.wordCount});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'BookModel(id: $id, name: $name, wordCount: $wordCount)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, wordCount);
...
abstract class _BookModel implements BookModel {
  const factory _BookModel(
      ...
      required final int wordCount}) = _$BookModelImpl;
